...
def test_camel_basic():
    camel = Camel(color="blue", track_pos=1, stack_pos=0)
    assert camel.color == "blue"
...
def test_camel_move():
    camel = Camel(color="red", track_pos=2, stack_pos=1)
...
def test_camel_move_above_board_size():
    camel = Camel(color="blue", track_pos=15, stack_pos=0)
...
def test_camel_move_below_one():
    camel = Camel(color="blue", track_pos=2, stack_pos=0)
